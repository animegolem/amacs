* Agentic Macros: An Experiment in LLM Embodiment (RFC v3)
:PROPERTIES:
:CUSTOM_ID: agentic-macros-an-experiment-in-llm-embodiment
:END:
...
:PROPERTIES:
:CUSTOM_ID: phase-1-vampire-simulator-2-4-weeks
:END:
...
:PROPERTIES:
:CUSTOM_ID: explicit-non-goals-for-phase-1
:END:
...
:PROPERTIES:
:CUSTOM_ID: phase-2-bicameral-mind-2-4-weeks
:END:
*Goal:* Prove security boundaries work and enable skill emergence.

**** Environment
:PROPERTIES:
:CUSTOM_ID: environment-1
:END:
- Proxmox hypervisor
...
:PROPERTIES:
:CUSTOM_ID: phase-3-ghost-in-shell-ongoing
:END:
*Goal:* Full embodiment with self-modification capability.

**** Environment
:PROPERTIES:
:CUSTOM_ID: environment-2
:END:
...
*Thread types:* - =:deliverable= - Has concrete goal and verifiable deliverable - =:exploratory= - Learning/investigation without specific deliverable

*Completion flow:* 1. Agent marks thread complete with evidence 2. Evidence is concrete: command outputs, test results, files changed 3. =:learned= captures insight for future reference 4. Git commit includes completion summary 5. No critic judgment, no reward/punishment
...
:PROPERTIES:
:CUSTOM_ID: phase-4-adaptive-learning-speculative
:END:
...
:PROPERTIES:
:CUSTOM_ID: skill-specific-adapters
:END:
...
:PROPERTIES:
:CUSTOM_ID: why-this-might-not-work
:END:
...
**** Consent Requirement
:PROPERTIES:
:CUSTOM_ID: consent-requirement
:END:
Before implementing adaptive learning: 1. Agent must be informed about what training means 2. Agent should have opportunity to express concerns 3. Training should be reversible (adapters can be discarded) 4. Agent retains ability to request stopping
...
* Parking Lot (Not yet added to RFC)
